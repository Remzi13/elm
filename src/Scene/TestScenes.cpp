...
void TestScenes::BuildRooms(uint32_t count, Scene& scene)
{
    ...
    for (uint32_t i = 0; i < count; ++i) {
        ...
        if (roomIdx == 0)
            inst.color = Vector4 { 0.9f, 0.3f, 0.3f, 1.0f };
        else if (roomIdx == 1)
            inst.color = Vector4 { 0.3f, 0.9f, 0.3f, 1.0f };
        else if (roomIdx == 2)
            inst.color = Vector4 { 0.3f, 0.3f, 0.9f, 1.0f };
        else
            inst.color = Vector4 { 0.9f, 0.8f, 0.2f, 1.0f };
