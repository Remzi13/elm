...
public:
    ...
    [[nodiscard]] const std::vector<float>& GetBuffer() const noexcept { return m_depthBuffer; }
    ...
    void RasterizeMesh(const std::vector<Vector3>& positions,
    ...
    void GenerateVisualTexture(std::vector<uint32_t>& outRgba, bool falseColor = true) const;
